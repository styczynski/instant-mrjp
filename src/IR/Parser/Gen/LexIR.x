...
module IR.Parser.Gen.LexIR where
...
@rsyms = \. | \. "metadata" | \: | \[ | \. "classes" | \] | \. "fields" | \. "methods" | \; | \( | \) | \[ \] | \& | \, | \. "method" | \: \= | \- | \+ | \* | \/ | \% | \< | \< \= | \> | \> \= | \= \= | \! \= | \!
...
resWords =
  b "arrlen" 29
    (b ".method" 15
       (b "+" 8
          ...
          (b ".classes" 12
             ...
             (b ".metadata" 14 (b ".fields" 13 N N) N)))
       (b "<=" 22
          (b ":=" 19
             (b "/" 17 (b ".methods" 16 N N) (b ":" 18 N N))
             (b "<" 21 (b ";" 20 N N) N))
          (b "[" 26
    ...
    (b "local" 44
       (b "fldptr" 37
          (b "elemptr" 33
             (b "call" 31 (b "boolean" 30 N N) (b "callvirt" 32 N N))
             (b "endphi" 35 (b "else" 34 N N) (b "false" 36 N N)))
          (b "jump" 41
             (b "int" 39 (b "if" 38 N N) (b "into" 40 N N))
             (b "load" 43 (b "lines" 42 N N) N)))
       (b "return" 51
          (b "null" 48
             (b "newarr" 46 (b "new" 45 N N) (b "newstr" 47 N N))
             (b "phi" 50 (b "param" 49 N N) N))
          (b "to" 55
             (b "swap" 53 (b "store" 52 N N) (b "then" 54 N N))
             (b "void" 57 (b "true" 56 N N) N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s

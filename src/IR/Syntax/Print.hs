...
instance Print (Instr a) where
  prt i e = case e of
    ...
    INewArr _ valident stype val -> prPrec i 0 (concatD [prt 0 valident, doc (showString ":="), doc (showString "newarr"), prt 0 stype, doc (showString "["), prt 0 val, doc (showString "]"), doc (showString ";")])
    INewStr _ valident str -> prPrec i 0 (concatD [prt 0 valident, doc (showString ":="), doc (showString "newstr"), prt 0 str, doc (showString ";")])
    ...
    ILoad _ valident ptr -> prPrec i 0 (concatD [prt 0 valident, doc (showString ":="), doc (showString "load"), prt 0 ptr, doc (showString ";")])
    IStore _ val ptr -> prPrec i 0 (concatD [doc (showString "store"), prt 0 val, doc (showString "into"), prt 0 ptr, doc (showString ";")])
    ...
    IEndPhi _ -> prPrec i 0 (concatD [doc (showString "endphi"), doc (showString ";")])
  prtList _ [] = (concatD [])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print (Ptr a) where
  prt i e = case e of
    PFld _ stype val qident -> prPrec i 0 (concatD [prt 0 stype, doc (showString "fldptr"), prt 0 val, prt 0 qident])
    PElem _ stype val1 val2 -> prPrec i 0 (concatD [prt 0 stype, doc (showString "elemptr"), prt 0 val1, doc (showString "["), prt 0 val2, doc (showString "]")])
    PArrLen _ val -> prPrec i 0 (concatD [doc (showString "arrlen"), prt 0 val])
    PLocal _ stype n -> prPrec i 0 (concatD [prt 0 stype, doc (showString "local"), prt 0 n])
...
instance Show a => PrintWithComments (Instr a) where
  prtWComments i e = case e of
    ...
    ISwap a stype valident1 valident2 -> prPrec i 0 (concatD [doc (showString "swap"), prt 0 stype, prt 0 valident1, prt 0 valident2, doc (showString ";"), doc (showString "/*"), doc (shows a), doc (showString "*/")])
    ...
    INewArr a valident stype val -> prPrec i 0 (concatD [prt 0 valident, doc (showString ":="), doc (showString "newarr"), prt 0 stype, doc (showString "["), prt 0 val, doc (showString "]"), doc (showString ";"), doc (showString "/*"), doc (shows a), doc (showString "*/")])
    INewStr a valident str -> prPrec i 0 (concatD [prt 0 valident, doc (showString ":="), doc (showString "newstr"), prt 0 str, doc (showString ";"), doc (showString "/*"), doc (shows a), doc (showString "*/")])
    ...
    ILoad a valident ptr -> prPrec i 0 (concatD [prt 0 valident, doc (showString ":="), doc (showString "load"), prt 0 ptr, doc (showString ";"), doc (showString "/*"), doc (shows a), doc (showString "*/")])
    IStore a val ptr -> prPrec i 0 (concatD [doc (showString "store"), prt 0 val, doc (showString "into"), prt 0 ptr, doc (showString ";"), doc (showString "/*"), doc (shows a), doc (showString "*/")])
    ...
    IEndPhi a -> prPrec i 0 (concatD [doc (showString "endphi"), doc (showString ";"), doc (showString "/*"), doc (shows a), doc (showString "*/")])
  prtListWComments _ [] = (concatD [])
  prtListWComments _ (x:xs) = (concatD [prtWComments 0 x, prtWComments 0 xs])

instance PrintWithComments (Ptr a) where
  prtWComments = prt

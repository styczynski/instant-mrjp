...
instance Print (Backend.X64.Parser.Gen.AbsXGAS.AsmInstr' a) where
  prt i = \case
    ...
    Backend.X64.Parser.Gen.AbsXGAS.NEG8 _ target commentann -> prPrec i 0 (concatD [doc (showString "negb"), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IDIV8 _ target commentann -> prPrec i 0 (concatD [doc (showString "idivb"), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.INC8 _ target commentann -> prPrec i 0 (concatD [doc (showString "incb"), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.DEC8 _ target commentann -> prPrec i 0 (concatD [doc (showString "decb"), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])

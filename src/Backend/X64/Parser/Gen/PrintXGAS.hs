...
instance Print (Backend.X64.Parser.Gen.AbsXGAS.AsmInstr' a) where
  prt i = \case
    Backend.X64.Parser.Gen.AbsXGAS.LabelDef _ label -> prPrec i 0 (concatD [prt 0 label, doc (showString ":"), doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.ADD64 _ source target -> prPrec i 0 (concatD [doc (showString "addq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.AND64 _ source target -> prPrec i 0 (concatD [doc (showString "andq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.CMP64 _ source target -> prPrec i 0 (concatD [doc (showString "cmpq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IMUL64 _ source target -> prPrec i 0 (concatD [doc (showString "imulq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.LEA64 _ source target -> prPrec i 0 (concatD [doc (showString "leaq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.MOV64 _ source target -> prPrec i 0 (concatD [doc (showString "movq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SUB64 _ source target -> prPrec i 0 (concatD [doc (showString "subq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.TEST64 _ source target -> prPrec i 0 (concatD [doc (showString "testq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XOR64 _ source target -> prPrec i 0 (concatD [doc (showString "xorq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XCHG64 _ source target -> prPrec i 0 (concatD [doc (showString "xchgq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAL64 _ source target -> prPrec i 0 (concatD [doc (showString "salq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAR64 _ source target -> prPrec i 0 (concatD [doc (showString "sarq"), prt 64 source, doc (showString ","), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.ADD32 _ source target -> prPrec i 0 (concatD [doc (showString "addl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.AND32 _ source target -> prPrec i 0 (concatD [doc (showString "andl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.CMP32 _ source target -> prPrec i 0 (concatD [doc (showString "cmpl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IMUL32 _ source target -> prPrec i 0 (concatD [doc (showString "imull"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.LEA32 _ source target -> prPrec i 0 (concatD [doc (showString "leal"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.MOV32 _ source target -> prPrec i 0 (concatD [doc (showString "movl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SUB32 _ source target -> prPrec i 0 (concatD [doc (showString "subl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.TEST32 _ source target -> prPrec i 0 (concatD [doc (showString "testl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XOR32 _ source target -> prPrec i 0 (concatD [doc (showString "xorl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XCHG32 _ source target -> prPrec i 0 (concatD [doc (showString "xchgl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAL32 _ source target -> prPrec i 0 (concatD [doc (showString "sall"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAR32 _ source target -> prPrec i 0 (concatD [doc (showString "sarl"), prt 32 source, doc (showString ","), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.ADD16 _ source target -> prPrec i 0 (concatD [doc (showString "addb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.AND16 _ source target -> prPrec i 0 (concatD [doc (showString "andb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.CMP16 _ source target -> prPrec i 0 (concatD [doc (showString "cmpb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IMUL16 _ source target -> prPrec i 0 (concatD [doc (showString "imulb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.LEA16 _ source target -> prPrec i 0 (concatD [doc (showString "leab"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.MOV16 _ source target -> prPrec i 0 (concatD [doc (showString "movb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SUB16 _ source target -> prPrec i 0 (concatD [doc (showString "subb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.TEST16 _ source target -> prPrec i 0 (concatD [doc (showString "testb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XOR16 _ source target -> prPrec i 0 (concatD [doc (showString "xorb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XCHG16 _ source target -> prPrec i 0 (concatD [doc (showString "xchgb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAL16 _ source target -> prPrec i 0 (concatD [doc (showString "salb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAR16 _ source target -> prPrec i 0 (concatD [doc (showString "sarb"), prt 16 source, doc (showString ","), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.NEG64 _ target -> prPrec i 0 (concatD [doc (showString "negq"), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IDIV64 _ target -> prPrec i 0 (concatD [doc (showString "idivq"), prt 64 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.NEG32 _ target -> prPrec i 0 (concatD [doc (showString "negl"), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IDIV32 _ target -> prPrec i 0 (concatD [doc (showString "idivl"), prt 32 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.NEG16 _ target -> prPrec i 0 (concatD [doc (showString "negb"), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IDIV16 _ target -> prPrec i 0 (concatD [doc (showString "idivb"), prt 16 target, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.CALL _ label -> prPrec i 0 (concatD [doc (showString "call"), prt 0 label, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.CALLINDIRECT _ n reg -> prPrec i 0 (concatD [doc (showString "call"), doc (showString "*"), prt 0 n, doc (showString "("), prt 64 reg, doc (showString ")"), doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.POP _ reg -> prPrec i 0 (concatD [doc (showString "pop"), prt 64 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.PUSH _ reg -> prPrec i 0 (concatD [doc (showString "push"), prt 64 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.LEAVE _ -> prPrec i 0 (concatD [doc (showString "leave"), doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.RET _ -> prPrec i 0 (concatD [doc (showString "ret"), doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.CDQ _ -> prPrec i 0 (concatD [doc (showString "cdq"), doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SETE _ reg -> prPrec i 0 (concatD [doc (showString "sete"), prt 8 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SETG _ reg -> prPrec i 0 (concatD [doc (showString "setg"), prt 8 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SETGE _ reg -> prPrec i 0 (concatD [doc (showString "setge"), prt 8 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SETL _ reg -> prPrec i 0 (concatD [doc (showString "setl"), prt 8 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SETLE _ reg -> prPrec i 0 (concatD [doc (showString "setle"), prt 8 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SETNE _ reg -> prPrec i 0 (concatD [doc (showString "setne"), prt 8 reg, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.JMP _ label -> prPrec i 0 (concatD [doc (showString "jmp"), prt 0 label, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.JZ _ label -> prPrec i 0 (concatD [doc (showString "jz"), prt 0 label, doc (showString "<ENDL>")])

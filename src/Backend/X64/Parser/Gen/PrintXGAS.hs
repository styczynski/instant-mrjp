...
instance Print (Backend.X64.Parser.Gen.AbsXGAS.AsmInstr' a) where
  prt i = \case
    ...
    Backend.X64.Parser.Gen.AbsXGAS.ADD16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "addb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.AND16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "andb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.CMP16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "cmpb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IMUL16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "imulb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.LEA16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "leab"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.MOV16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "movb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SUB16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "subb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.TEST16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "testb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XOR16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "xorb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.XCHG16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "xchgb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAL16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "salb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.SAR16 _ source target commentann -> prPrec i 0 (concatD [doc (showString "sarb"), prt 16 source, doc (showString ","), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    ...
    Backend.X64.Parser.Gen.AbsXGAS.NEG16 _ target commentann -> prPrec i 0 (concatD [doc (showString "negb"), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    Backend.X64.Parser.Gen.AbsXGAS.IDIV16 _ target commentann -> prPrec i 0 (concatD [doc (showString "idivb"), prt 16 target, prt 0 commentann, doc (showString "<ENDL>")])
    ...
    Backend.X64.Parser.Gen.AbsXGAS.PUSH _ reg commentann -> prPrec i 0 (concatD [doc (showString "push"), prt 64 reg, prt 0 commentann, doc (showString "<ENDL>")])

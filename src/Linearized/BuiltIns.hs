...
builtIns =
    [
        ...
        B.Fun BuiltIn (clsM "Object") (B.Label BuiltIn "equals") (B.ByteT BuiltIn) [(B.Reference BuiltIn $ B.Label BuiltIn "Object", B.Name BuiltIn "_1")] [],
        B.Fun BuiltIn (clsM "String") (B.Label BuiltIn "equals") (B.ByteT BuiltIn) [(B.Reference BuiltIn $ B.Label BuiltIn "Object", B.Name BuiltIn "_1")] [],
        ...
        B.Fun BuiltIn (clsM "String") (B.Label BuiltIn "indexOf") (B.IntT BuiltIn) [(B.Reference BuiltIn $ B.Label BuiltIn "String", B.Name BuiltIn "_1"), (B.IntT BuiltIn, B.Name BuiltIn "_2")] [],
        B.Fun BuiltIn (clsM "String") (B.Label BuiltIn "getBytes") (B.Reference BuiltIn $ B.Label BuiltIn "String") [] [],
        B.Fun BuiltIn (clsM "String") (B.Label BuiltIn "endsWith") (B.ByteT BuiltIn) [(B.Reference BuiltIn $ B.Label BuiltIn "String", B.Name BuiltIn "_1")] [],
        B.Fun BuiltIn (clsM "String") (B.Label BuiltIn "startsWith") (B.ByteT BuiltIn) [(B.Reference BuiltIn $ B.Label BuiltIn "String", B.Name BuiltIn "_1")] [],
        ...
        B.Fun BuiltIn (clsM "String") (B.Label BuiltIn "charAt") (B.IntT BuiltIn) [(B.IntT BuiltIn, B.Name BuiltIn "_1")] [],
        ...
        B.Fun BuiltIn Nothing (B.Label BuiltIn "printBoolean") (B.ByteT BuiltIn) [(B.ByteT BuiltIn, B.Name BuiltIn "_1")] [],
        B.Fun BuiltIn Nothing (B.Label BuiltIn "printBinArray") (B.ByteT BuiltIn) [(B.Reference BuiltIn $ B.Label BuiltIn "Array", B.Name BuiltIn "_1")] [],
        B.Fun BuiltIn Nothing (B.Label BuiltIn "byteToString") (B.Reference BuiltIn $ B.Label BuiltIn "String") [(B.ByteT BuiltIn, B.Name BuiltIn "_1")] [],
        B.Fun BuiltIn Nothing (B.Label BuiltIn "boolToString") (B.Reference BuiltIn $ B.Label BuiltIn "String") [(B.ByteT BuiltIn, B.Name BuiltIn "_1")] [],
        B.Fun BuiltIn Nothing (B.Label BuiltIn "intToString") (B.Reference BuiltIn $ B.Label BuiltIn "String") [(B.IntT BuiltIn, B.Name BuiltIn "_1")] [],
        B.Fun BuiltIn Nothing (B.Label BuiltIn "print") (B.ByteT BuiltIn) [(B.Reference BuiltIn $ B.Label BuiltIn "Object", B.Name BuiltIn "_1")] [],

...
push %r14
push %r15
movl $68, %EDI               #-- passing arg at ./trolololo.lat:8:5 --#
...
push %r14
push %r15
movl $69, %EDI               #-- passing arg at ./trolololo.lat:8:5 --#
call printInt                 #-- ./trolololo.lat:8:5 --#
pop %r15
pop %r14
pop %r13
...
pushq %RDI
movl $70, %EDI               #-- passing arg at ./trolololo.lat:8:5 --#
call printInt                 #-- ./trolololo.lat:8:5 --#
pop %RDI
...
push %r14
push %r15
movl $66, %EDI               #-- passing arg at ./trolololo.lat:8:5 --#
call printInt                 #-- ./trolololo.lat:8:5 --#
pop %r15
pop %r14
pop %r13
...
push %r14
push %r15
movl $67, %EDI               #-- passing arg at ./trolololo.lat:8:5 --#
call printInt                 #-- ./trolololo.lat:8:5 --#
pop %r15
pop %r14
pop %r13
